...
export const Icons = {
  ...
  Calendar: ({ size = 20, ...props }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      height={size}
  ...
  FileText: ({ size = 20, ...props }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      height={size}
  ...
  ScaleBalance: ({ size = 20, ...props }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M19 7v5a7 7 0 0 1-14 0V7" />
      <path d="M3 22h18" />
    </svg>
  ),

  Folder: ({ size = 20, ...props }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      height={size}
